...
[![Build Status](https://travis-ci.org/tbopec/angular5-example-shopping-app.svg?branch=master](https://travis-ci.org/tbopec/angular5-example-shopping-app.svg?branch=master)
